...
public class RangeSlider extends JComponent implements SwingConstants, Accessible {
    ...
    {
        this.orientation = RangeSlider.HORIZONTAL;
        setModel(brm);
        updateUI();
    }
     ...
     * to this RangeSlider with addChangeListener().
     *
    ...
    /**
     * Send a {@code ChangeEvent}, whose source is this {@code RangeSlider}, to
     ...
     *         enum: VERTICAL RangeSlider.VERTICAL
     *               HORIZONTAL RangeSlider.HORIZONTAL
     *
     */
...
*/
        ...
        class SmartHashtable extends Hashtable<Object, Object> implements PropertyChangeListener {
            ...
            public void propertyChange( PropertyChangeEvent e ) {
                ...
                if ( e.getPropertyName().equals( "minimum" ) ||
                    ...
                    ((RangeSlider)e.getSource()).setLabelTable( this );
                }
            }
    ...
    */
    ...
    /**
     * Returns a string representation of this RangeSlider. This method
     * is intended to be used only for debugging purposes, and the
     * content and format of the returned string may vary between
     * implementations. The returned string may be empty but may not
     * be <code>null</code>.
     *
     * @return  a string representation of this RangeSlider.
     */
...
////////////////
    ...
    /**
     * Gets the AccessibleContext associated with this RangeSlider.
     * For sliders, the AccessibleContext takes the form of an
     * AccessibleRangeSlider.
     * A new AccessibleRangeSlider instance is created if necessary.
     *
     * @return an AccessibleRangeSlider that serves as the
     *         AccessibleContext of this RangeSlider
     */
    public AccessibleContext getAccessibleContext() {
        if (accessibleContext == null) {
            accessibleContext = new AccessibleRangeSlider();
        }
     ...
     * <code>RangeSlider</code> class.  It provides an implementation of the
     ...
     * Please see {@link java.beans.XMLEncoder}.
     */
    protected class AccessibleRangeSlider extends AccessibleJComponent
        ...
        public Number getMaximumAccessibleValue() {
            // TIGER - 4422362
            BoundedRangeModel model = RangeSlider.this.getModel();
