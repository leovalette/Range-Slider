...
public class RangeSliderDemo extends JPanel {
	...
	RangeSliderDemo(int min, int max, int lower, int upper, String label) {
		...
		add(rangeSliderLabel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.NONE, new Insets(0, 0, 3, 3), 0, 0));

		add(rangeSliderLowerLabel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.NONE, new Insets(0, 0, 3, 3), 0, 0));

		add(this.rangeSliderLowerValue, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.NONE, new Insets(0, 0, 3, 3), 0, 0));

		add(rangeSliderUpperLabel, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.NONE, new Insets(0, 0, 3, 3), 0, 0));

		add(this.rangeSliderUpperValue, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.NONE, new Insets(0, 0, 3, 3), 0, 0));

		add(this.rangeSlider, new GridBagConstraints(0, 3, 2, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST,
	 ...
	 * RangeSliderDemo rangeSlider1 = new RangeSliderDemo(0, 10, 2, 8,
	 * "RangeSlider1"); rangeSlider1.display(); } }); }
	 */
}